        ...
        <div className={footerStyles.grid}>
          ...
          <div>
            <h2 className={footerStyles.brandTitle}>
              Grocery<span className={footerStyles.brandSpan}>App</span>
            </h2>
            <p className={footerStyles.brandText}>
              Bringing you the freshest organic produce since 2025. Our mission is to deliver farm-fresh goodness straight to your doorstep.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm sm:text-base">
              <li className={footerStyles.contactItem}>
                ...
                <div>
                  <p>Marwadi University Rajkot 360001</p>
                </div>
              </li>
              <li className={footerStyles.contactItem}>
                <div className={footerStyles.contactIconContainer}>
        ...
        <div className={footerStyles.attribution}>
          <div className={footerStyles.attributionBadge}>
            ...
            <span className={footerStyles.attributionText}>
              Designed by{' '}
              <a
                href="https://marwadiuniversity.ac.in"
                target="_blank"
                rel="noopener noreferrer"
                className={footerStyles.attributionLink}
              >
                Marwadi University Project
              </a>
            </span>
          </div>
        </div>
